  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-3 mb-6">
      ...
      <div className="bg-white p-3 md:p-4 rounded-[12px] shadow-sm">
        ...
        <p className="text-xl md:text-2xl lg:text-3xl font-bold text-amber-500">{stats.pending}</p>
      </div>
      
      <div className="bg-white p-3 md:p-4 rounded-[12px] shadow-sm">
        <p className="text-sm text-gray-500 mb-1">In Progress</p>
        <p className="text-xl md:text-2xl lg:text-3xl font-bold text-blue-500">{stats.inProgress}</p>
      </div>
