      ...
      {step === 2 && (
        <VStack gap={5}>
          <VStack gap="none" align="start" justify="between" style={{ marginBottom: 'var(--spacing-4)' }} className="sm:flex-row sm:items-center">
            ...
            <Surface bg="brand" padding="var(--spacing-1) var(--spacing-3)" radius="full" color="muted" size="sm" style={{ marginTop: 'var(--spacing-2)' }} className="sm:mt-0">{parsedData.length} students will be added</Surface>
          </VStack>
