  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {filteredStaff.length === 0 && <NoResults icon={<FaUserTie style={{ color: 'var(--color-border-primary)', fontSize: 'var(--icon-3xl)' }} />} message={`No ${staffTitle.toLowerCase()}s found`} suggestion="Try changing your search or filter criteria" />}
