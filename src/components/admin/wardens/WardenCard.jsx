    ...
    <div className="bg-white rounded-[20px] p-6 shadow-[0px_1px_20px_rgba(0,0,0,0.06)] relative hover:shadow-md transition duration-300">
      ...
      <div className="flex items-center">
        ...
        <div>
          ...
          <p className={`text-xs mt-1 ${statusColor.light} ${statusColor.text} inline-block px-2 py-0.5 rounded-full`}>{warden.status === "active" ? "Active" : "Unassigned"}</p>
        </div>
      </div>
      ...
      <div className="mt-4 space-y-3 text-sm">
        ...
        <div className="flex items-center">
          ...
          <span className="font-medium">{warden.hostelAssigned || "Not assigned to any hostel"}</span>
        </div>
      </div>
      ...
      <div className="mt-6 pt-4 border-t border-gray-100 flex justify-between items-center">
        ...
        <div className="flex space-x-2">
          <button className="p-2 bg-blue-50 text-[#1360AB] rounded-lg hover:bg-blue-100 transition duration-200">
            <FaEdit />
          </button>
          <button className="p-2 bg-red-50 text-red-600 rounded-lg hover:bg-red-100 transition duration-200">
            <FaTrash />
          </button>
        </div>
      </div>
