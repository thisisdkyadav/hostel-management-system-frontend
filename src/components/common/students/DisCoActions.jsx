  ...
  return (
    <div className="px-4 ">
      <div className="flex justify-between items-center mb-2">
        ...
        <button
          className="bg-[#1360AB] text-white px-4 py-2 mb-2 rounded-lg hover:bg-blue-500"
        ...
        <form onSubmit={handleSubmit} className="bg-gray-50 p-4 rounded mb-6">
          ...
          <div className="mb-4 mt-3">
            ...
            <textarea
              ...
              onChange={handleChange}
              className="w-full h-25 border border-gray-300 focus:border-[#1360AB] focus:ring-1 focus:ring-blue-300 p-2 rounded-lg outline-none resize-none"
            />
          </div>
