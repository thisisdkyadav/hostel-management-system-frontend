      ...
      {loading ? (
        ...
        <>
            ...
            <div className="bg-gray-50 p-5 rounded-xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="space-y-2.5">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-sm">{studentDetails.hostel?.name || "N/A"}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600 text-sm">Hostel Type:</span>
                  <span className="font-medium text-sm">{studentDetails.hostel?.type || "N/A"}</span>
                </div>
                {studentDetails.hostel?.type === "unit-based" && (
                  <div className="flex justify-between">
                    <span className="text-gray-600 text-sm">Unit Number:</span>
                    <span className="font-medium text-sm">{studentDetails.unit?.unitNumber || "N/A"}</span>
                  </div>
                )}
                <div className="flex justify-between">
                  <span className="text-gray-600 text-sm">Room Number:</span>
                  <span className="font-medium text-sm">{studentDetails.room?.roomNumber || "N/A"}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600 text-sm">Bed Number:</span>
                  <span className="font-medium text-sm">{studentDetails.bed || "N/A"}</span>
                </div>
              </div>
            </div>
          ...
          <div className="mt-6 flex justify-end space-x-4 pt-4 border-t border-gray-100">
            ...
            <button className="px-4 py-2.5 bg-[#1360AB] text-white rounded-lg hover:bg-blue-700 transition-colors shadow-sm">Edit Student</button>
          </div>
        </>
      )}
    </Modal>
