  ...
  const columns = [
    {
      ...
      render: (student) => (
        <div className="flex items-center">
          <div className="flex-shrink-0 h-8 w-8 rounded-full bg-blue-50 flex items-center justify-center">{student.profileImage ? <img src={student.profileImage} alt={student.name} className="h-8 w-8 rounded-full object-cover" /> : <FaUserGraduate className="h-4 w-4 text-[#1360AB]" />}</div>
          <div className="ml-3">
