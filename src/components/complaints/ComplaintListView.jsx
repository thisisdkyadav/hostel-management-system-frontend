          ...
          <tbody className="bg-white divide-y divide-gray-100">
            {complaints.map((complaint, index) => (
              <tr key={complaint.id || index} className={`transition-colors hover:bg-blue-50 ${index % 2 === 0 ? "bg-white" : "bg-gray-50"}`}>
                ...
                <td onClick={() => handleStudentClick(complaint.reportedBy?.id)} aria-label="View student details" className="px-4 py-3 whitespace-nowrap hidden md:table-cell *:cursor-pointer">
