...
const StudentElectionWorkspace = ({
  ...
  return (
    ...
    {selectedStudentElection.mode === "upcoming" ? (
      <Text as="div" color="body" style={{ border: "1px solid var(--color-border-primary)", borderRadius: "var(--radius-xl)", backgroundColor: "var(--color-bg-secondary)", padding: "var(--spacing-5)" }}>
