    ...
    <>
      <Modal title="Leave Request Details" onClose={onClose} width={800}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-6)' }}>
          ...
          <div style={{
            ...
            <div>
              <span style={{
                ...
                ...getStatusStyle(leave.status || "Pending")
          ...
          {/* User Info */}
          <div style={{
            background: 'linear-gradient(to right, var(--color-primary-bg), var(--color-primary-bg-light))',
        ...
        >
          <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-6)' }}>
            ...
            <div style={{
              padding: 'var(--spacing-4)',
              borderRadius: 'var(--radius-xl)',
              border: `var(--border-1) solid ${decisionType === "approve" ? 'var(--color-success-bg)' : 'var(--color-danger-border)'}`,
              backgroundColor: decisionType === "approve" ? 'var(--color-success-bg-light)' : 'var(--color-danger-bg-light)'
            }}>
            ...
            <div style={{
              ...
              <button
                ...
                onMouseEnter={(e) => !decisionLoading && (e.target.style.backgroundColor = decisionType === "approve" ? 'var(--color-success-hover)' : 'var(--color-danger-hover)')}
      ...
      {showJoinModal && (
        <Modal
          title={
            <div style={{ display: 'flex', alignItems: 'center', color: 'var(--color-info-text)' }}>
              <svg style={{ ...iconSizeLg, marginRight: 'var(--spacing-2)' }} fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 011-1z" clipRule="evenodd" />
              </svg>
              Join Leave Request
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-6)' }}>
            ...
            <div style={{
              ...
              <button
                ...
                onMouseEnter={(e) => !joinLoading && (e.target.style.backgroundColor = 'var(--color-info-hover)')}
                onMouseLeave={(e) => e.target.style.backgroundColor = 'var(--color-info)'}
                onFocus={(e) => e.target.style.boxShadow = 'var(--shadow-focus-primary)'}
                onBlur={(e) => e.target.style.boxShadow = 'var(--shadow-sm)'}
