    ...
    <Modal title="Password Updated" onClose={onClose} width={500}>
      <div style={{ textAlign: 'center', paddingTop: 'var(--spacing-4)', paddingBottom: 'var(--spacing-4)' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center' }}>
          <button onClick={onClose} style={{ padding: 'var(--spacing-3) var(--spacing-6)', backgroundColor: 'var(--button-primary-bg)', color: 'var(--color-white)', borderRadius: 'var(--radius-lg)', transition: 'var(--transition-all)', boxShadow: 'var(--shadow-sm)', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', fontSize: 'var(--font-size-base)', fontWeight: 'var(--font-weight-medium)' }} onMouseEnter={(e) => {
