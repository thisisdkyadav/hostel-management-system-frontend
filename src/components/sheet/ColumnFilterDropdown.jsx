...
const ColumnFilterDropdown = ({ column, columnId, data, isOpen, onClose, onApplyFilter, currentFilter }) => {
  ...
  return (
    <div ref={dropdownRef} style={styles.dropdown} onClick={(e) => e.stopPropagation()}>
      ...
      <div style={styles.footer}>
        <button style={styles.clearButton} onClick={handleClear} onMouseEnter={(e) => (e.currentTarget.style.color = "var(--color-text-body)")} onMouseLeave={(e) => (e.currentTarget.style.color = "var(--color-text-muted)")}>
          Clear
        </button>
        <button
          style={{
