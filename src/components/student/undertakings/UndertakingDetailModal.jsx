    ...
    <Modal title={undertaking.title} onClose={handleClose} size="lg">
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between bg-gray-50 p-4 rounded-lg">
          ...
          <div className="flex items-center">
            ...
            <span className="text-sm text-gray-600">
              ...
              {deadlinePassed && <span className="ml-2 text-xs text-red-600">(Overdue)</span>}
            </span>
          </div>
        </div>
        ...
        <div className="flex items-start">
          <input type="checkbox" id="confirm-read" checked={hasConfirmed} onChange={() => setHasConfirmed(!hasConfirmed)} className="mt-1 h-4 w-4 text-blue-600 rounded border-gray-300 focus:ring-blue-500" />
        ...
        <div className="flex justify-end space-x-3 pt-4 border-t border-gray-100">
          ...
          <button type="button" onClick={handleAccept} disabled={isAccepting || !hasConfirmed} className={`px-4 py-2 rounded-lg flex items-center ${hasConfirmed ? "bg-green-600 text-white hover:bg-green-700" : "bg-gray-300 text-gray-500 cursor-not-allowed"}`}>
