          ...
          <div style={{ flexShrink: '0' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center' }}>
              {request.studentProfileImage ? (
                ...
                <div style={{ height: 'var(--avatar-md)', width: 'var(--avatar-md)', borderRadius: 'var(--radius-full)', backgroundColor: 'var(--color-bg-muted)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--color-text-muted)' }}>{request.studentName?.charAt(0) || "?"}</div>
              )}
