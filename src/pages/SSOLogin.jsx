  ...
  if (error) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white overflow-hidden">
        ...
        {/* Error Content */}
        <div className="w-full max-w-screen-xl px-6 md:px-8 lg:px-12 mx-auto flex flex-col lg:flex-row items-center justify-between mt-12">
          <div className="lg:w-1/2 text-center lg:text-left">
            ...
            <p className="text-gray-600 text-lg md:text-xl mb-10 max-w-xl mx-auto lg:mx-0 leading-relaxed">{error}</p>
          ...
          <div className="lg:w-1/2 mt-16 lg:mt-0 flex justify-center lg:justify-end">
            <div className="relative w-full max-w-md">
              ...
              <div className="rounded-2xl overflow-hidden shadow-2xl p-8 backdrop-blur-md bg-white/90 relative z-10 border border-red-100/80">
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 via-indigo-50 to-blue-100 overflow-hidden">
      ...
      <div className="w-full max-w-screen-xl px-6 md:px-8 lg:px-12 mx-auto flex flex-col lg:flex-row items-center justify-between mt-12">
        <div className="lg:w-1/2 text-center lg:text-left">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-gray-800 mb-6 animate-slideUp tracking-tight">
            Logging you into
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600 mt-2">Hostel Management System</span>
          </h1>

          <p className="text-gray-600 text-lg md:text-xl mb-10 max-w-xl mx-auto lg:mx-0 leading-relaxed">Please wait while we securely authenticate your credentials and prepare your personalized dashboard.</p>
        </div>
        ...
        <div className="lg:w-1/2 mt-16 lg:mt-0 flex justify-center lg:justify-end">
          <div className="relative w-full max-w-md">
            ...
            <div className="rounded-2xl overflow-hidden shadow-2xl p-8 backdrop-blur-md bg-white/90 relative z-10 border border-blue-100/80">
