...
const Attendance = () => {
  ...
  useEffect(() => {
    const fetchAttendanceHistory = async () => {
      try {
        setLoading(true)
        // Fetch security guard attendance history using the unified API
        const response = await securityApi.getStaffAttendanceRecords({ staffType: "security", userId: user?._id })
  ...
  return (
    <div className="px-4 py-6 md:px-6 lg:px-8 ">
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-800 mb-2">Security Attendance</h1>
