...
const Settings = () => {
    ...
    return (
        <div className='bg-neutral-100 fixed h-screen w-screen'>
            ...
            <div className='absolute left-[5%] top-[200px] bg-white flex flex-col gap-5 !p-3 w-[35%] rounded-2xl'>
                ...
                <div className='flex flex-col items-start justify-center gap-6'>
                    ...
                    <div className='flex items-center gap-3'>
                        ...
                        <p>Department : {student.userId.department == undefined ? "undefined" : student.userId.department}</p>
                    </div>
                    <div className='flex items-center gap-3'>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='absolute left-[50%] top-[200px] bg-white flex flex-col gap-5 w-[27%] !p-3 rounded-2xl'>
            ...
            {isOpenProfile && (
                <div className="fixed inset-0 flex items-center justify-center z-50">
                    ...
                    <div className="relative bg-[#1360AB] w-[40%] p-6 rounded-[12px] shadow-lg">
                        ...
                        <div className="flex flex-col gap-3">
                            <input type="text" placeholder="Name" className="p-2 rounded-[12px] bg-gray-200 w-full" />
                            <input type="email" placeholder="Email" className="p-2 rounded-[12px] bg-gray-200 w-full" />
                            <input type="text" placeholder="Phone No." className="p-2 rounded-[12px] bg-gray-200 w-full" />
                            <input type="text" placeholder="Department" className="p-2 rounded-[12px] bg-gray-200 w-full" />
                            <input type="text" placeholder="Hostel" className="p-2 rounded-[12px] bg-gray-200 w-full" />

                            <button className="bg-green-500 text-black px-6 py-2 rounded-md hover:bg-green-600" onClick={() => alert("Profile updated")}>
                                UPDATE
                            </button>
                        </div>
                    </div>
