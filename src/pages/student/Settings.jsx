...
const Settings = () => {
  ...
  return (
    <div className="bg-gray-100 fixed h-screen w-screen">
      <div className="absolute top-[40px] left-[2%] flex items-center justify-between w-[80vw] [@media(max-width:900px)]:hidden">
        ...
        <div className="flex items-center justify-center gap-15">
          ...
          <div className="flex items-center justify-center gap-1">
            <div>
              <img src={student.profileImageURL != undefined ? getMediaUrl(student.profileImageURL) : getMediaUrl(user.profileImage)} className="w-12 h-12 rounded-full" alt="userImg" />
            </div>
      ...
      <div className="absolute left-[5%] top-[140px] bg-white flex flex-col gap-5 !p-3 w-[35%] h-[65%] rounded-2xl">
        <div className="flex items-center gap-7 justify-start ">
          <svg width="40" height="44" viewBox="0 0 40 44" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              d="M21.6666 40.2427C21.1184 40.3027 20.5624 40.3333 19.9999 40.3333C10.7952 40.3333 3.33325 32.1251 3.33325 22C3.33325 11.8747 10.7952 3.66663 19.9999 3.66663C29.2046 3.66663 36.6666 11.8747 36.6666 22C36.6666 22.6187 36.6388 23.2303 36.5843 23.8333"
              stroke="black"
              stroke-width="1.5"
              stroke-linecap="round"
            />
            <path
              d="M12.5 31.1667C14.8374 28.4737 18.3687 27.3242 21.6667 27.8559M24.1585 17.4167C24.1585 19.948 22.2903 22 19.9858 22C17.6815 22 15.8133 19.948 15.8133 17.4167C15.8133 14.8854 17.6815 12.8334 19.9858 12.8334C22.2903 12.8334 24.1585 14.8854 24.1585 17.4167Z"
              stroke="black"
              stroke-width="1.5"
              stroke-linecap="round"
            />
        ...
        <div className="flex flex-row items-center justify-start gap-10 mt-30">
          <div className="bg-[#F4F5F7] text-[#808080] !p-2 rounded-xl cursor-pointer" onClick={() => setIsOpenRoom(true)}>
            Room change
          </div>
          <div className="bg-[#F4F5F7] text-[#808080] !p-2 rounded-xl cursor-pointer" onClick={() => setIsOpenProfile(true)}>
            Edit Profile
          </div>
        </div>
      </div>
      ...
      <div className="absolute left-[50%] top-[140px] bg-white flex flex-col gap-5 w-[27%] !p-3 rounded-2xl">
        <div className="flex items-center justify-between">
          <div className="flex gap-3 items-center justify-start">
            <img src={getMediaUrl(userr)} className="h-10 w-10 rounded-full" alt="" />
      ...
      {isOpenProfile && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          <div className="absolute inset-0 bg-opacity-20 backdrop-blur-sm" onClick={() => setIsOpenProfile(false)}></div>

          <div className="relative bg-[#1360AB] w-[40%] p-6 rounded-[12px] shadow-lg">
            <button className="absolute top-3 right-3 text-white text-xl" onClick={() => setIsOpenProfile(false)}>
              &times;
            </button>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-3">
              <input type="text" name="name" value={formData.name} onChange={handleChange} placeholder="Name" className="p-2 rounded-[12px] bg-gray-200 w-full" />
              <input type="email" name="email" value={formData.email} onChange={handleChange} placeholder="Email" className="p-2 rounded-[12px] bg-gray-200 w-full" />
              <input type="text" name="phone" value={formData.phone} onChange={handleChange} placeholder="Phone No." className="p-2 rounded-[12px] bg-gray-200 w-full" />
              <input type="text" name="department" value={formData.department} onChange={handleChange} placeholder="Department" className="p-2 rounded-[12px] bg-gray-200 w-full" />
              <input type="text" name="hostel" value={formData.hostel} onChange={handleChange} placeholder="Hostel" className="p-2 rounded-[12px] bg-gray-200 w-full" />

              <button type="submit" className="bg-green-500 text-black px-6 py-2 rounded-md hover:bg-green-600">
                UPDATE
              </button>
            </form>
          </div>
